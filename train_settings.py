SAVABLE = {
    ...
    'IMPORT_PATH': './brains.json',  # последний импортированный файл
    'EXPORT_PATH': './brains.json',  # последний путь экспорта
    'BEST_BRAINS': []  # лучшие экземпляры мозгов ботов
}

SERIA_STEP = 0  # номер текущей игры в серии
SERIA_NUMBER = 0  # номер текущей серии
LAST_SAVE = 0  # время последнего автосохранения
TRAIN_IS_ON = False  # в процессе ли тренировка
MAX_WIN = 0  # максимальный выигрыш
BEST_BOT = None  # лучший игрок
MAX_STREAK = 0  # наибольшее количество непроигранных серий у лучшего бота
